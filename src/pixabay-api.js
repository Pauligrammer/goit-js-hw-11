...
export function renderPhotos(images) {
    const photoCard = images
        .map(image => {
            return `<div class="photo-card"><a href="${image.largeImageURL}" class="link"><img src="${image.webformatURL}" alt="${image.tags}" loading="lazy"/></a><div class="info overlay"><p class="info-item">
                <b>Likes:</b>
                ${image.likes}
                </p>
                <p class="info-item">
